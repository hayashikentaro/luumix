# 0001: Analysis-first implementation plan

## Status

Accepted as the initial project direction.
...
Therefore the first implementation goal should not be a full player. The first goal should be an analysis workbench that can generate metadata a human can visually inspect and judge as correct enough.
...
The initial product should treat playback as a later consumer of this metadata.
